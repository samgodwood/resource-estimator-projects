...
# Define the path to the beamsplitter JSON file
file_path = "./results/beamsplitter/beamsplitter.json"
...
output_path_cutoff = "./results/beamsplitter/hilbert_cutoff_plot.pdf"
...
# Save the plot to a PDF file
output_path_photon_loss = "./results/beamsplitter/error_budget_plot.pdf"
